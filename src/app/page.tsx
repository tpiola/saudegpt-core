    ...
    <main className="bg-animated" style={{
      ...
      <div className="glass" style={{
        ...
        <p style={{
          ...
          O <strong style={{ color: '#D4A843' }}>SaúdeGPT Core</strong> será o centro inteligente do ecossistema, 
          unificando os cursos de Farmácia, Nutrição, Fisioterapia e Psicologia 
          em uma plataforma EAD completa com IA.
        </p>
        ...
        <div style={{
          ...
          {['CRF-SP', 'CRN', 'CREFITO', 'CRP'].map((council) => (
            <span key={council} style={{
        ...
        {enviado ? (
          <div style={{
            ...
            <p style={{ color: '#8899AA', fontSize: '0.85rem', marginTop: '0.5rem' }}>
              Aviseremos quando o curso estiver disponível.
            </p>
          </div>
        ) : (
